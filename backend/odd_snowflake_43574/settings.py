"""
Django settings for odd_snowflake_43574 project.
...
ROOT_URLCONF = 'odd_snowflake_43574.urls'
...
WSGI_APPLICATION = 'odd_snowflake_43574.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_snowflake_43574 API",
    "DESCRIPTION": "API documentation for odd_snowflake_43574 App",
    "VERSION": "v1",
}
